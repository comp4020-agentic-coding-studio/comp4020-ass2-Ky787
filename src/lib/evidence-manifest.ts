...
export const evidenceFiles: readonly string[] = [
  ...
  "assets/ir/s07_polaris_bcf/target_function.ll",
  ...
  "assets/evidence/baselines/tigress/demo_substitution_disassembly.txt",
  ...
  // --- rewriting evidence ----------------------------------------------
  "assets/evidence/s03_ollvm_bcf/patch_manifest.json",
  ...
  "assets/evidence/s07_polaris_bcf/patch_manifest.json",
  "assets/evidence/s07_polaris_bcf/original_target_disassembly.txt",
  "assets/evidence/s07_polaris_bcf/rewritten_target_disassembly.txt",
  ...
  "assets/evidence/s04_ollvm_fla/provenance_region_map.json",
  ...
  "assets/evidence/s05_polaris_fla_wrong/clean_cfg.txt",
  "assets/evidence/s05_polaris_fla_wrong/before_cfg.txt",
  "assets/evidence/s05_polaris_fla_wrong/after_cfg.txt",
  "assets/evidence/s08_tigress_flatten/clean_cfg.txt",
  "assets/evidence/support_hikari_fla/before_cfg.txt",
  "assets/evidence/support_hikari_fla/after_cfg.txt",
  "assets/evidence/support_hikari_fla/output_runtime_stdout.txt",
  "assets/evidence/s05_polaris_fla_wrong/provenance_region_map.json",
  "assets/evidence/s05_polaris_fla_wrong/instrumentation.json",
  ...
  "assets/evidence/support_hikari_fla/original/target_function_disassembly.txt",
  ...
  "assets/evidence/s08_tigress_flatten/provenance_region_map.json",
  ...
  "assets/evidence/mergen_summaries/cases.json",
  ...
  "assets/evidence/matrix/optimization_metrics.json",
